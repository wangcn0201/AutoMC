...
class KnowledgeModel(torch.nn.Module):
	...
	def GetKGInfo(self, knowledge_path):
		...
		with open(knowledge_path + '/kg_reverse_entity_mapping.pkl', 'rb') as file:
			reverse_entity_mapping = pickle.load(file)
		with open(knowledge_path + '/kg_entity_mapping.pkl', 'rb') as file:
			entity_mapping = pickle.load(file)
		with open(knowledge_path + '/kg_relation_mapping.pkl', 'rb') as file:
			relation_mapping = pickle.load(file)
		with open(knowledge_path + '/kg_kg_info.pkl', 'rb') as file:
	...
	def GetExpInfo(self, knowledge_path):
		...
		with open(knowledge_path + '/exp_infos_1.pkl', 'rb') as file:
			exp_infos_1 = pickle.load(file)
		with open(knowledge_path + '/exp_infos_2.pkl', 'rb') as file:
		...
		task_info_dim = task_infos_1.shape[1]
